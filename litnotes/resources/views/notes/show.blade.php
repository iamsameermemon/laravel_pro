        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                <form action="{{ route('trashed.destroy', $note) }}" method="post">
                    @method('delete')
                    @csrf
                    <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are you sure you wish to delete this note permanently? This action will not be reversed.')">Permanent Delete</button>
                </form>
                @else
                    <p class="opacity-70">
